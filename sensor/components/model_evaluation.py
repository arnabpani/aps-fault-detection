...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->artifact_entity.ModelEvaluationArtifact:
        try:
            ...
            current_target_encoder = load_object(file_path=target_encoder_path)
            ...
            print(f"print prediction usig previous values: {target_encoder.inverse_transform(y_pred[:5])}")
            ...
            print(f"print prediction usig trained values: {current_target_encoder.inverse_transform(y_pred[:5])}")
            current_model_score = f1_score(y_true=y_true, y_pred = y_pred)

            if current_model_score > previous_model_score:
                raise Exception("Current trained model not better than previous model")
